...
# 🗄️ Cours Bases de Données & SQL — ISI

> **Formateur :** Robert | **Établissement :** ISI (Institut Supérieur d'Informatique)
> **Niveaux :** Licence 1 & Licence 2

Ce dépôt couvre les fondamentaux des bases de données relationnelles : modélisation, algèbre relationnelle, normalisation et SQL.
...
| Cours | Lien |
|-------|------|
| PHP (avec MySQL) | [CoursPHP](https://github.com/Robsroberto/CoursPHP) |
| Merise & UML | [CoursMerise_UML](https://github.com/Robsroberto/CoursMerise_UML) |
